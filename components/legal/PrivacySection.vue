<template>
	<section class="container py-5 justify-content-center">
		...
		>
			<ol>
				<li class="mb-2">A first and last name.</li>
				<li class="mb-2">
					A home or other physical address, including street name and
					name of a city or town.
				</li>
				<li class="mb-2">An e-mail address.</li>
				<li class="mb-2">telephone number.</li>
				<li class="mb-2">A social security number.</li>
				<li class="mb-2">
					Any other identifier that permits the physical or online
					contacting of a specific individual.
				</li>
				<li class="mb-2">
					Information concerning a user that the Web site or online
					service collects online, from the user, and maintains in
					personally identifiable form, in combination with an
					identifier described within this privacy policy.
				</li>
			</ol>
		</div>
		<text-item :text="text.slice(28, text.length)" />
	...
	data() {
		return {
			text: [
				...
				`<b>Personal Information Our Company Collects and How It Is Used</b>`,
				...
				"Our Company Partners and Sponsors: Some products and services may be offered to Visitors and Members in conjunction with an affiliate, independent contractor seller or non-affiliated partner.",
				...
				'Under California Law SB 27, California residents have the right to receive, once a year, information about third parties with whom we have shared information about you or your family for their marketing purposes during the previous calendar year, if any, and a description of the categories of personal information shared. To make such a request, please send an email to contact@flamelean.com and please include the phrase "California Privacy Request" in the subject line, the domain name of the Web site you are inquiring about, along with your name, address and email address. We will respond to you within thirty days of receiving such a request.',
				...
				"Revisions to This Policy: Our company reserves the right to revise, amend, or modify this policy, our Terms Of Service agreement, and our other policies and agreements at any time and in any manner, by updating this posting. Your use of this site after such changes are implemented constitutes your acknowledgement and acceptance of these changes. Please consult this privacy statement prior to every use for any changes.Opting Out: Should you wish to no longer receive email communication from us, simply send an email to support@flamelean.com and we will remove you from our database. Also, at the bottom of any email you might receive from us is an unsubscribe link that, when clicked, will automatically unsubscribe you.\n",
			],
		};
	},
};
