<template>
	<section class="container pt-5 pb-3 justify-content-center">
		...
		>
			<ol>
				<li class="mb-2">
					any link provided in connection with the services,
				</li>
				<li class="mb-2">your reliance on any of the services,</li>
				<li class="mb-2">
					the interruption, suspension, termination of any of the
					services,
				</li>
				<li class="mb-2">
					any viruses that may infect your computer equipment or other
					property on account of your use of the site, or
				</li>
				<li class="mb-2">
					any matter otherwise related to your use of the site or
					services.
				</li>
			</ol>
		</div>
...
import ListItem from "@/components/footer-pages/ListItem";
	...
	data() {
		return {
			...
			orderedList: [
				...
				`<b>8. Refund Policy.</b> Your purchase is fully protected by a 60 day, 100% money-back return policy. In order to obtain a refund under this policy, you must follow the instructions found in our Shipping and Returns Policy. You can contact our retailer BuyGoods for billing and refund support at https://www.buygoods.com, or contact the vendor, Flamelean by emailing support@flamelean.com.`,
