	...
	data() {
		return {
			outOfStock: {
                ...
                `,
				text: `
                    The last thing I want is for you to start experiencing a sense of confidence
                    and control over your body…
                    <br class="d-none d-lg-flex" />
                    Only to find out that we’re out of stock when you need more bottles!
                    <br class="d-none d-lg-flex" />
                    That’s the bad news.
                `,
			},
			specialOffer: {
				title: `Here’s The Special Offer
                    <br class="d-none d-sm-flex" />
