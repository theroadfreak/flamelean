<template>
	<div class="container-fluid bg-primary text-white py-5">
		<div class="col-lg-8 mx-auto small justify-content-around">
			<div class="mb-3">
				Statements found on this website have not been evaluated by the
				Food and Drug Administration. Products on this website are not
			...
			<div>
				...
				AVAILABLE" basis. You should do your own research and confirm
				the information with other sources when searching for
				...
				examples found on this page are results that have been forwarded
				to us by users of FlameLean products and related products are
				not intended to represent or guarantee that anyone will achieve
